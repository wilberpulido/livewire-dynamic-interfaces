<div class="mx-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    <div class="w-64">
        <a href="{{ route('threads.create')  }}" class="block w-full py-4 mb-10  font-bold text-xs text-center rounded-md capitalize dark:bg-gradient-to-r dark:from-blue-600 dark:to-blue-700 dark:hover:to-blue-600 dark:text-white/90" >
            {{__('threads.show.ask') }}
        </a>
        <ul>
